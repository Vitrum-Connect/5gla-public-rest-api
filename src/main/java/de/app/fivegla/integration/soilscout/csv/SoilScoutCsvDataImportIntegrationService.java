package de.app.fivegla.integration.soilscout.csv;
...
@Slf4j
@Service
public class SoilScoutCsvDataImportIntegrationService {
    ...
    public List<SensorData> readSensorDataFromCsv(String csvData) {
        try {
            ...
            throw new BusinessException(ErrorMessage.builder().error(Error.SOIL_SCOUT_CSV_DATA_IMPORT_FAILED).message("Could not read CSV data from the given input.").build());
        }
    }
