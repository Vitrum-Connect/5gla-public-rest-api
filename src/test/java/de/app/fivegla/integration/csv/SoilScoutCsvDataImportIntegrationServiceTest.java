...
/**
 * Test for {@link SoilScoutCsvDataImportIntegrationService}.
 */
class SoilScoutCsvDataImportIntegrationServiceTest {

    private final SoilScoutCsvDataImportIntegrationService soilScoutCsvDataImportIntegrationService = new SoilScoutCsvDataImportIntegrationService();
    ...
    void givenValidCsvDataForImportWhenReadingHeadersThenTheServiceShouldReturnTheHeaders() throws Throwable {
        ...
        var sensorData = soilScoutCsvDataImportIntegrationService.readSensorDataFromCsv(fileContent);
